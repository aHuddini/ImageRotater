...
{
    // Binds a group of RadioButtons to a single DisplayMode property. Each
    // button passes its own mode name as ConverterParameter and is checked only
    // when the setting equals it.
    public class DisplayModeConverter : IValueConverter
    {
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            // previous button must not also write, or it would race the new
            // value.
