...
| **Fullscreen cover rotation needs Playnite 10.57+** | Older Playnite never notified the property Fullscreen tiles bind, so covers stayed frozen. Fixed upstream in 10.57 ([one line, submitted from this project](docs/THEME_INTEGRATION.md#the-fullscreen-grid-cover-problem-fixed-in-playnite-1057)); the plugin-side workaround is gone. |
